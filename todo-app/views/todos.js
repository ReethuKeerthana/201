<h5>
  <%= title %><span
    class="bg-gray-100 text-gray-800 text-sm font-small mr-2 px-2.5 py-0.5 rounded dark:bg-gray-200 dark:text-gray-900 justify-center items-center items-center items"
    ><%= data.length %></span
  >
</h5>
<ul class="list-none">
  ...
  <li class="todo-item">
    ...
    >
      ...
      data[i].completed ? "checked" : "" %> onclick="updateTodo(<%= data[i].id
